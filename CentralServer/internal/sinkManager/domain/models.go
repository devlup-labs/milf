...
const (
	MsgTaskAssignment WsMessageType = "task_assignment"
	MsgTaskResult     WsMessageType = "task_result"
...
type SinkManagerService interface {
	...
	UnregisterWebSocket(sinkID string)
	SendWebSocketMessage(sinkID string, msgType WsMessageType, payload interface{}) error
}
