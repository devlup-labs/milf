...
// InitSchema contains all the database table creation scripts for the application.
// This is executed automatically when the backend server starts.
const InitSchema = `
...
-- Create billing_usage table if not exists
